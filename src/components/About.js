      ...
      <main className="about-content">
        <div className="container">
          ...
          <div className="about-text">
            <p>
              RoomRental Nepal is the leading online platform for finding and listing rooms for rent across Nepal. Our
              mission is to simplify the process of finding comfortable and affordable accommodation for tenants while
              providing landlords with a reliable platform to list their properties.
            </p>
            <p>
              Founded in 2020, we have quickly grown to become the most trusted name in Nepal's room rental market. Our
              team of dedicated professionals works tirelessly to ensure that our platform remains user-friendly,
              secure, and up-to-date with the latest market trends.
            </p>
            <h2>Our Vision</h2>
            <p>
              To revolutionize the room rental experience in Nepal by leveraging technology to create a seamless,
              transparent, and efficient marketplace for both tenants and landlords.
            </p>
            <h2>Our Values</h2>
            <ul>
          ...
          <section className="how-it-works">
            ...
            <div className="steps-grid">
              ...
              <div className="step">
                ...
                <h3>Move In</h3>
                <p>
                  Once you've found your ideal room, complete the booking process and prepare for your move-in date.
                </p>
              </div>
            </div>
          </section>
